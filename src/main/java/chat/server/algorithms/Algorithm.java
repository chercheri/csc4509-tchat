...
public enum Algorithm {
	 ...
	 */
	ALGORITHM_ELECTION(chat.server.algorithms.election.ElectionAction.values()),
	
	/**
	 * the mutual exclusion algorithm.
	 */
	ALGORITHM_MUTEX(chat.server.algorithms.mutex.MutexAction.values());
